...
Una <mark>*bola*</mark> en $\RR^p$, de *centro* $\xx_0$ y *radio* $r$, es un conjunto de la forma
$$
...
Sean $\aa_1,\aa_2\in\RR^p$ no nulos, y $b_1,b_2\in\RR$. Definimos la intersección de dos semiespacios como
$$
...
::: {.column width="30%"}
<figure style="text-align: center;">
  <img src="figuras/cono_normal_04.png" alt="Cono normal a la intersección de dos semiespacios" style="width: 75%">
</figure>
