...
Observar que estas definen explícitamente a $\bfbeta$ en términos de $\bflambda$ y, aunque $\beta_0$ no queda determinado de forma directa, sí nos provee una restricción de consistencia sobre los multiplicadores. Reemplazando, obtenemos
$$
\begin{align}
...
El cálculo de productos internos en $\calH$ será fundamental para la generalización de SVM. Para un $\calH$ arbitrario, conocer explícitamente su producto interno $\langle\cdot,\cdot\rangle_{\calH}$ resulta ser una limitación práctica. Una manera de sortear esto es utilizar un *espacio de Hilbert con núcleo reproductor* (RKHS).
...
Veamos el efecto de trabajar con RKHS para el cálculo de productos internos de la forma (11). Las propiedades de la Definición 5 implican que
