...
$$
\hat{\yy} := (h_{\bftheta}(\xx_1),\ldots,h_{\bftheta}(\xx_n))^\top=\sigma(X\bftheta).
$$
...
Ajustaremos un modelo de regresión logística a los datos, evaluaremos el *accuracy* en test y presentaremos los coeficientes estimados del modelo.
