...
Esto significa que $\lambda \mathbf{s}$ es una combinación lineal de las filas de $X_{\mathcal{E}}$. Por lo tanto, la proyección de $\lambda\mathbf{s}$ sobre el espacio fila de $X_{\mathcal{E}}$ es el mismo $\lambda\mathbf{s}$.. Esto es:
$$
...
En la sección anterior ([C2-S2](https://isaiasibanez.github.io/OML2/CAPITULO_2/B2_glm.html#optimalidad)) hemos estudiado la aplicación del principio de máxima verosimilitud para el ajuste de parámetros de un modelo lineal generalizado (GLM). El problema de optimización asociado puede ser definido como 
$$
\begin{array}{ll}
