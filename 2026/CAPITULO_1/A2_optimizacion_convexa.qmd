...
- El *interior relativo* de $C$ respecto a $\aff C$ es
    $$
    \relint C:=\left\{\xx\in C\,\left|\exists r>0: B(\xx,r)\cap \aff C\subset C\right.\right\},
    $$
...
Como consecuencia, a pesar de que el interior de $C$ es vacío ($\int C=\emptyset$), el interior relativo es
$$
\relint C=(-1,1)\times(-1,1)\times\{0\}.
$$
