...
<figure style="text-align: center;">
  <img src="figuras/combinacion_convexa.svg" alt="" width="250px">
...
<figure style="text-align: center;">
  <img src="figuras/conjunto_convexo.svg" alt="" width="450px">
...
El resultado obtenido es $(7.39,21.18)$, que pertenece a la envolvente convexa de los tres puntos dados.
...
::: {.column width="40%"}
<figure style="text-align: center;">
  <img src="figuras/ej_combinacion_convexa.svg" alt="" width="300px">
</figure>
:::
:::
:::
...
<figure style="text-align: center;">
  <img src="figuras/cono_dos_puntos.svg" alt="" width="250px">
  <figcaption>**Figura 1.2.4:** Conjunto de puntos de la forma $\theta_1\xx_1+\theta_2\xx_2$ para $\xx_1,\xx_2\in\RR^2$.</figcaption>
</figure>

<div style="margin-top:2em;"></div>

Luego, esta caracterización le permitirá probar fácilmente que un conjunto $C$ es un cono convexo si y solo si contiene todas las combinaciones cónicas de sus puntos (✏1).
...
$$
  ...
  Como su nombre lo indica, la envolvente convexa es siempre un conjunto convexo (✏3). Más aún, $\conv C$ es el conjunto convexo más pequeño que contiene a $C$; esto es, si $E$ es cualquier conjunto convexo que contiene a $C$, entonces $\conv C \subset E$. 
...
$$
  ...
  La envolvente cónica es siempre un conjunto convexo (✏3). Más aún, $\cone C$ es el cono convexo más pequeño que contiene a $C$.

<div style="margin-top:1em;"></div>

<figure style="text-align: center;">
  <img src="figuras/envolvente_convexa_conica.svg" alt="" width="450px">
  <figcaption>**Figura 1.2.5:** Envolvente convexa y envolvente cónica de un mismo conjunto de puntos.</figcaption>
</figure>
</div>
...
<figure style="text-align: center;">
  <img src="figuras/ej_cuadrado_R3.svg" alt="" width=100%>
</figure>
...
$$
es un conjunto convexo, ya que es la imagen del disco unitario $\bar{B}(\bfzero,1):=\{\xx\in\RR^2\mid\|\xx\|_2\leq 1\}$ bajo la transformación afín $f:\RR^2\to\RR^2$ definida por
$$
f(\xx)=P^{1/2}\xx+\xx_0.
$$
...
<figure style="text-align: center;">
  <img src="figuras/hiperplano.svg" alt="" width="300px">
  <figcaption>**Figura 1.2.6:** Hiperplano con vector normal $\bfa$.</figcaption>
</figure>
...
::: {.callout .question}
<span style="font-size: 1.3em;">✍️</span><br>
Verifique que una bola en $\RR^p$ es un conjunto convexo.
:::
...
<figure style="text-align: center;">
  <img src="figuras/poliedro.svg" alt="" width="250px">
  <figcaption>**Figura 1.2.7:** Un poliedro generado por la intersección de 5 semiespacios.</figcaption>
</figure>
...
<figure style="text-align: center;">
  <img src="figuras/ej_simplex.svg" alt="" width="300px">
  <figcaption>**Figura 1.2.8:** $\Delta^2$ es un triángulo en $\RR^3$ de vértices $(1,0,0)$, $(0,1,0)$ y $(0,0,1)$.</figcaption>
</figure>
...
En muchos problemas de optimización, especialmente aquellos en los que las soluciones están restringidas a un conjunto convexo, es esencial entender cómo se comportan las direcciones &laquo;externas&raquo; al conjunto en torno a un punto dado.
...
::: {.definicion}
**Definición 1.2.10** (Cono normal). Sean $\Omega\subset\RR^p$ un conjunto convexo y $\xx_0\in\Omega$. El *cono normal de $\Omega$ en $\xx$* se define como
$$
...
<figure style="text-align: center;">
  ...
  <figcaption> **Figura 1.2.9:** Interpretación geométrica de las direcciones $\dd$ y $\xx-\xx_0$. </figcaption>
</figure>
...
<span class="badge bg-primary">Ejemplo 1.2.11</span>
<span style="color: #0d6efd; font-family: Arial; font-weight: bold; font-size: 0.85em;">
...
::: {.column width="65%"}
Sean $\bfa\in\RR^p$, $\bfa\neq\mathbf{0}$, y $b\in\RR$. Consideramos el semiespacio
$$
...
::: {.column width="65%"}
Sean $\bfa_1,\bfa_2\in\RR^p$ no nulos, y $b_1,b_2\in\RR$. Consideramos la intersección de dos semiespacios
$$
...
::: {.definicion}
**Definición 1.2.15** (Función convexa). Una función $f:\RR^p\rightarrow\RR$ es *convexa* si $\dom f$ es un conjunto convexo y si verifica
$$
...
<figure style="text-align: center;">
  <img src="figuras/funcion_convexa_01.png" alt="" width="400px">
  <figcaption>**Figura 1.2.10:** Grafo de una función convexa.</figcaption>
</figure>
...
La desigualdad de la Definición 1.2.15 se puede extender a combinaciones convexas. Es decir, si $f$ es convexa, se cumple
$$
...
<span class="badge bg-primary">Ejemplo 1.2.16</span>
<span style="color: #0d6efd; font-family: Arial; font-weight: bold; font-size: 0.85em;">
...
<figure style="text-align: center;">
  <img src="figuras/epigrafo_01.png" alt="" width="350px">
  <figcaption>**Figura 1.2.11:** Epígrafo de una función $f$.</figcaption>
</figure>
...
::: {.teorema}
**Lema 1.2.17** (Convexidad en una variable). Sea $\varphi:[a,b]\to\RR$ una función convexa. Se verifican las siguientes propiedades:
...
::: {.teorema}
**Teorema 1.2.18** (Condición de primer orden para convexidad).
...
<figure style="text-align: center;">
  <img src="figuras/condicion_convexidad_01.png" alt="" width="500px">
  <figcaption>**Figura 1.2.12:** Grafo de una función convexa $f$ y su aproximación lineal.</figcaption>
</figure>
...
Podemos aplicar el Lema 1.2.17 con $t=1$ y $t_0=0$; resulta
$$
\begin{align}
...
El siguiente gráfico muestra la interpretación geométrica tanto de la Definición 1.2.15 de convexidad como del Teorema 1.2.18 de condición de primer orden.
...
<p style="text-align:center; font-size:0.9em; color:#6c757d;">
<b>Figura 1.2.13:</b> Comportamiento de un método iterativo en un problema de optimización.
</p>


<div style="margin-top:2em;"></div>

Una consecuencia importante del Teorema 1.2.18 es la siguiente: si para algún $\xx_0\in\dom f$ se verifica $\nabla f(\xx_0) =\bfzero$, entonces $f(\xx) \geq f(\xx_0)$ para todo $\xx \in \dom f$. Es decir, podemos afirmar que:
...
::: {.teorema}
**Teorema 1.2.19** (Condición de segundo orden para convexidad). 
...
Como $f$ es convexa y dos veces diferenciable, podemos afirmar que también $\psi$ es convexa y dos veces diferenciable en $t$. Por lo tanto, el Lema 1.2.17 nos asegura que $\psi''(t)\geq 0$ para todo $t$. Derivando, obtenemos
$$
...
lo cual es la condición de primer orden (Teorema 1.2.18) aplicada a $\xx_1=\xx$ y $\xx_2=\xx+\dd$. Luego, $f$ es convexa. $\qquad\blacksquare$
:::
</details>
...
<span class="badge bg-primary">Ejemplo 1.2.20</span> 
<span style="color: #0d6efd; font-family: Arial; font-weight: bold; font-size: 0.85em;">
...
::: {.teorema}
**Teorema 1.2.26** (Optimalidad global de un mínimo local en problemas convexos). Si $\xx\in\Omega$ es un mínimo local de un problema de optimización convexa, entonces $\xx$ es un punto óptimo (es decir, un mínimo global).
