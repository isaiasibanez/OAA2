...
<span class="badge bg-primary">Ejemplo 1.5.1</span> Vamos a utilizar el método de descenso por gradiente para aproximarnos al valor mínimo de 
...
<span class="badge bg-primary">Ejemplo 1.5.7</span> Vamos a utilizar el método de descenso por gradiente proyectado para resolver el problema
$$
\begin{array}{ll}
...
Escriba la demostración del Teorema 1.5.9, siguiendo el razonamiento usado para el Teorema 3.
...
<span class="badge bg-primary">Ejemplo 1.5.10</span> Vamos a utilizar el método de Newton para aproximarnos al valor mínimo de 
...
Flammarion, N. *EPFL CS-439: Optimization for machine learning*. 🔗 [ir al sitio web](https://github.com/epfml/OptML_course).
