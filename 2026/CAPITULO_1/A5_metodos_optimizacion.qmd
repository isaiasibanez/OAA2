...
::: {.teorema}
**Teorema 6.** Sea $f:\RR^p\to\RR$ una función dos veces diferenciable y sea $\xx_\star$ un punto crítico. Supongamos que existe una bola $B(\xx_\star,\varepsilon)\subset \dom f$ tal que:
