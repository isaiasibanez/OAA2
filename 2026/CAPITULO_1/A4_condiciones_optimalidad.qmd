...
::: {.teorema}
**Teorema 1.4.13.** (Caracterización de optimalidad mediante KKT) Sea un problema de optimización convexa de la forma
$$ 
\begin{array}{ll} 
\text{minimizar } & f(\xx)\\ 
\text{sujeto a } & \xx\in\left\{\xx\in\RR^p\left|\;\begin{array}{ll}
...
Farina, G. *MIT 6.7220: Nonlinear Optimization*. 🔗 [ir al sitio web](https://www.mit.edu/~gfarina/notes/).
