...
<figure style="text-align: center;">
  <img src="figuras/cono_normal_generalization.svg" alt="" width="400px">
...
donde $I(\xx^\star):=\left\{i\in\{1,\cdots,r\} \mid g_i(\xx^\star)=0\right\}$ es el conjunto de restricciones activas. Por supuesto, el uso del conjunto índice $I$ puede evitarse utilizando holgura complementaria, tal como antes.
