...
donde $\Omega$ está definido como una intersección de restricciones funcionales diferenciables. La generalización del análisis previo surge del siguiente hecho:
...
<figure style="text-align: center;">
  <img src="figuras/conic_hull_generalization.svg" alt="" width="400px">
  <figcaption>**Figura 1.4.3:** Linearización de restricciones activas en un punto $\xx_0\in\Omega$.</figcaption>
</figure>
...
Por condición de optimalidad de primer orden sin restricciones para funciones convexas (Teorema 1.4.1), la expresión (12) implica que $\xx_0$ es el minimizador de $L(\xx_0)$. Además, es fácil ver que $L(\xx)\leq f(\xx)$ para todo $\xx$ factible. En consecuencia, se deduce
$$
...
Luego, $\xx_0$ es punto óptimo del problema, tal como queríamos probar. Luego, $\xx_0$ es punto óptimo del problema, tal como queríamos probar.
<div style="margin-top:-1em;"></div>
<div style="text-align: right;">$\blacksquare$</div>
