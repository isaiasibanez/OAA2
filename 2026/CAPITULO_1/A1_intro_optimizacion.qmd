...
Luego, el valor óptimo es  $p^\star=f(2)=1.$
:::
...
<figure style="text-align: center;">
  <img src="figuras/ej_funcion_cuadratica.svg" alt="" width=90%>
</figure>
...
<figure style="text-align: center;">
  <img src="figuras/ej_funcion_cubica.png" alt="" width=100%>
</figure>
...
<figure style="text-align: center;">
  <img src="figuras/ej_funcion_cuadratica_restringida.png" alt="" width=100%>
</figure>

:::
:::

y la restricción, se obtienen los puntos críticos $(1,1)$ y $(-1,-1)$, ambos con $\lambda=2$. El valor $f(1,1)=f(-1,-1)=2$ es óptimo de la función objetivo en el conjunto factible. Por lo tanto, hay dos puntos óptimos:
$$
\xx_1^\star=(1,1),\qquad \xx_2^\star=(-1,-1). 
$$

<figure style="text-align: center;">
  <img src="figuras/ej_funcion_cuadratica_restringida_2.svg" alt="" width=35%>
  <figcaption>**Figura 1.1.1**. El problema (1.1.3) puede ser interpretado geométricamente como *hallar el punto de la hipérbola $xy=1$ más cercano al origen*. </figcaption>
</figure>
