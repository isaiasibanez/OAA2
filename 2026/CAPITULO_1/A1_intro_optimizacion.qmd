...
$$
$$
\xx^\star\in\argmin\{f(x) \mid \xx\in \dom f\;\land\xx\in\Omega\}.
$$
...
- Un problema es *sin restricciones* si no tiene restricciones explícitas. Es decir, su dominio es $\mathcal{D}:=\dom f$.
