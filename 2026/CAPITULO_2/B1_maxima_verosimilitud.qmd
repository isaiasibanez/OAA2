...
$$
\operatorname{Var}(\tilde{\phi})\geq \frac{\phi_\star(1-\phi_\star)}{n}
$$
	
En particular, el MLE $\hat{\phi}$ alcanza esta cota para cualquier tamaño muestral $n$, ya que
$$
\var(\hat{p})=\var\left(\frac{1}{n}\sum_{i=1}^n Y_i\right)=\frac{1}{n^2}\sum_{i=1}^n\var(Y_i)=\frac{\phi_{\star}(1-\phi_{\star})}{n},
$$
	
donde hemos usado el hecho que $\{Y_1,\ldots,Y_n\}$ son i.i.d. y que, bajo el modelo especificado, $\var(Y_i)=\phi_{\star}(1-\phi_{\star})$.
