...
$$
	\begin{array}{c}
		...
		A''(\eta)=\sigma'(\eta)=\sigma(\eta)(1-\sigma(\eta))=h_{\bftheta}(\xx)(1-h_{\bftheta}(\xx))=\cov\left[Y\mid\XX=\xx\right].
	\end{array}
  \tag{2.2.2}
$$
...
donde
$$
W:=\diag(w_1,\ldots,w_n)\qquad\text{con }w_i:=A''(\eta_i)=h_{\bftheta}(\xx_i)(1-h_{\bftheta}(\xx_i)).
$$
