...
- $\prob(A)$ la probabilidad de que ocurra un suceso $A$.
...
- *Convergencia estadística*:
    ...
    $$
        se verifica
    $$
    \hat{\bftheta}_n\xrightarrow{p}\bftheta^\star\qquad\text{y}\qquad\sqrt{n}\, (\hat{\bftheta}_n-\bftheta^\star)\xrightarrow{d}\calN(0,\sigma^2\Sigma_X^{-1}).
    $$
...
- *Convergencia estadística*: 
    ...
    se verifica
    $$
    \hat{\bftheta}_n\xrightarrow{p}\bftheta^\star\qquad\text{y}\qquad\sqrt{n}\, (\hat{\bftheta}_n-\bftheta^\star)\xrightarrow{d}\calN(0,\mathcal{I}(\bftheta^\star)^{-1}).
    $$
